...
long SPEED = 20; // 20 rpm - Any faster an the steps seem to get out of sync
...
byte parseLine(char *line) {
    ...
    case CMD_AXIS_DISTANCE_XY:
        AXIS_DISTANCE_XY = readLong(line);
        setSteps();
